    ...
    <div style="max-width:400px;margin-top:1rem;">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div style="margin-bottom:1rem;">
                <label>Name</label>
                <input type="text" name="name" value="{{ old('name') }}" required style="width:100%;padding:0.5rem;border-radius:6px;border:1px solid #ddd;" />
            </div>
            ...
            <div style="margin-bottom:1rem;">
                ...
                <input type="password" name="password_confirmation" required style="width:100%;padding:0.5rem;border-radius:6px;border:1px solid #ddd;" />
            </div>
